...
var feieyun = require('./config').feieyun;

var USER = feieyun.user;//必填，飞鹅云 www.feieyun.cn后台注册的账号名
var UKEY = feieyun.ukey;//必填，飞鹅云后台注册账号后生成的UKEY
...
var SIG = crypto.createHash('sha1').update(USER+UKEY+STIME).digest('hex');//获取签名
...
function fill_with(text,width=16,char=' '){
    var n = (width - len(text));
...
module.exports = {
    ...
    queryOrderInfoByDate:queryOrderInfoByDate,
